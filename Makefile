...
SRC_SHARED	:= \
src/cam/cam_init.c                              src/gui/gui_init.c \
src/cmd/add/cmd_add.c                           src/gui/gui_list_widgets.c \
src/cmd/add/cmd_add_camera.c                    src/gui/gui_singals.c \
src/cmd/add/cmd_add_cone.c                      src/gui/gui_style.c \
src/cmd/add/cmd_add_copy.c                      src/lgt/lgt_init.c \
src/cmd/add/cmd_add_cylinder.c                  src/mat/mat_init.c \
src/cmd/add/cmd_add_group.c                     src/mtl/fio_png_write.c \
src/cmd/add/cmd_add_light.c                     src/obj/obj_container_init.c \
src/cmd/add/cmd_add_material.c                  src/obj/obj_copy_init.c \
src/cmd/add/cmd_add_plane.c                     src/obj/obj_init.c \
src/cmd/add/cmd_add_sphere.c                    src/rt.c \
src/cmd/add/cmd_add_txr.c                       src/scn/add/scn_add_cam.c \
src/cmd/add/cmd_add_txr_to_scn.c                src/scn/add/scn_add_ligth.c \
src/cmd/cmd_error.c                             src/scn/add/scn_add_mat.c \
src/cmd/cmd_parce_command.c                     src/scn/add/scn_add_obj.c \
src/cmd/cmd_parse.c                             src/scn/add/scn_add_to_group.c \
src/cmd/ls/cmd_ls.c                             src/scn/add/scn_add_to_group_copy.c \
src/cmd/render/cmd_render.c                     src/scn/add/scn_add_to_group_grp.c \
src/cmd/rm/cmd_rm.c                             src/scn/add/scn_add_to_group_obj.c \
src/cmd/rm/cmd_rm_by_name.c                     src/scn/add/scn_add_txr.c \
...
src/cmd/set/cmd_set_cone.c                      src/scn/get/scn_get_obj_num.c \
...
src/cmd/set/cmd_set_light.c                     src/scn/print/scn_print_grp.c \
src/cmd/set/cmd_set_material.c                  src/scn/print/scn_print_mat.c \
src/cmd/set/cmd_set_obj_to_scn.c                src/scn/print/scn_print_obj.c \
...
src/cmd/set/cmd_set_prepare_obj.c               src/scn/remove/scn_remove_by_name_copy.c \
src/cmd/set/cmd_set_sphere.c                    src/scn/remove/scn_remove_by_name_grp.c \
src/cmd/set/cmd_set_txr.c                       src/scn/remove/scn_remove_by_name_lgt.c \
...
src/cmd/utils/cmd_read_num.c                    src/scn/scn_id.c \
src/cmd/utils/cmd_read_png_buf.c                src/scn/scn_init.c \
src/cmd/utils/cmd_read_txr.c                    src/scn/utils/scn_del_copies_of.c \
src/cmd/utils/cmd_read_txr_png.c                src/scn/utils/scn_group_mem.c \
src/cmd/utils/cmd_set_read_attributes.c         src/scn/utils/scn_name.c \
src/cmd/utils/cmd_set_read_part.c               src/srv/srv_deinit.c \
src/err/msg_err.c                               src/srv/srv_ext.c \
src/err/msg_ok.c                                src/srv/srv_ext_data.c \
src/err/msg_warn.c                              src/srv/srv_init.c \
src/err/rt_err.c                                src/srv/srv_loop.c \
src/err/rt_warn.c                               src/srv/srv_parse.c \
src/gpu/gpu_buffer_load.c                       src/srv/srv_utils.c \
src/gpu/gpu_buffer_objects.c                    src/tfm/tfm_apply.c \
src/gpu/gpu_init.c                              src/tfm/tfm_init.c \
src/gpu/gpu_kernel_run.c                        src/tfm/tfm_move.c \
src/grp/grp_init.c                              src/txr/txr_init.c \
src/grp/grp_remove_by_name.c                    src/vlk/vlk_init.c \
src/gui/gui_builder.c \
