...
src/cmd/add/cmd_add.c                           src/scn/add/scn_add_cam.c \
src/cmd/add/cmd_add_camera.c                    src/scn/add/scn_add_mat.c \
src/cmd/add/cmd_add_cone.c                      src/scn/add/scn_add_obj.c \
src/cmd/add/cmd_add_cylinder.c                  src/scn/add/scn_add_to_group.c \
src/cmd/add/cmd_add_group.c                     src/scn/add/scn_add_to_group_copy.c \
src/cmd/add/cmd_add_material.c                  src/scn/add/scn_add_to_group_grp.c \
src/cmd/add/cmd_add_plane.c                     src/scn/add/scn_add_to_group_obj.c \
src/cmd/add/cmd_add_sphere.c                    src/scn/add/scn_add_txr.c \
src/cmd/cmd_parce_command.c                     src/scn/get/scn_get_cam_by_name.c \
src/cmd/cmd_parse.c                             src/scn/get/scn_get_mat_by_name.c \
src/cmd/ls/cmd_ls.c                             src/scn/get/scn_get_obj_by_id.c \
...
src/cmd/utils/cmd_add_obj_to_scn.c              src/scn/remove/scn_remove_by_name_mat.c \
...
src/cmd/utils/cmd_set_obj.c                     src/scn/scn_id.c \
