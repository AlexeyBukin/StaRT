...
SRC_SHARED	:= \
src/cam/cam_init.c                              src/scn/add/scn_add_to_group_obj.c \
src/cmd/add/cmd_add.c                           src/scn/add/scn_add_txr.c \
src/cmd/add/cmd_add_plane.c                     src/scn/get/scn_get_cam_by_name.c \
src/cmd/add/cmd_add_sphere.c                    src/scn/get/scn_get_mat_by_name.c \
src/cmd/cmd_parce_command.c                     src/scn/get/scn_get_obj_by_id.c \
src/cmd/cmd_parse.c                             src/scn/get/scn_get_obj_by_name.c \
src/cmd/ls/cmd_ls.c                             src/scn/get/scn_get_txr_by_name.c \
src/cmd/set/cmd_set.c                           src/scn/print/scn_print.c \
src/cmd/set/cmd_set_cylinder.c                  src/scn/print/scn_print_cam.c \
src/cmd/set/cmd_set_object_attributes.c         src/scn/print/scn_print_grp.c \
src/cmd/set/cmd_set_plane.c                     src/scn/print/scn_print_mat.c \
src/cmd/set/cmd_set_sphere.c                    src/scn/print/scn_print_txr.c \
src/cmd/set/cmd_set_transform_part.c            src/scn/remove/scn_remove_by_name_cam.c \
src/cmd/utils/cmd_read.c                        src/scn/remove/scn_remove_by_name_copy.c \
src/cmd/utils/cmd_read_num.c                    src/scn/remove/scn_remove_by_name_grp.c \
src/err/msg_err.c                               src/scn/remove/scn_remove_by_name_mat.c \
src/err/msg_ok.c                                src/scn/remove/scn_remove_by_name_obj.c \
src/err/msg_warn.c                              src/scn/remove/scn_remove_by_name_txr.c \
src/err/rt_err.c                                src/scn/scn_get_mat.c \
src/err/rt_warn.c                               src/scn/scn_id.c \
src/gpu/gpu_buffer_load.c                       src/scn/scn_init.c \
src/gpu/gpu_init.c                              src/scn/scn_name.c \
src/gpu/gpu_kernel_run.c                        src/scn/utils/scn_del_copies_of.c \
src/grp/grp_init.c                              src/scn/utils/scn_group_mem.c \
src/grp/grp_remove_by_name.c                    src/srv/srv_deinit.c \
src/gui/gui_init.c                              src/srv/srv_ext.c \
src/mat/mat_init.c                              src/srv/srv_ext_data.c \
src/obj/obj_container_init.c                    src/srv/srv_init.c \
src/obj/obj_copy_init.c                         src/srv/srv_loop.c \
src/obj/obj_init.c                              src/srv/srv_parse.c \
src/rt.c                                        src/srv/srv_utils.c \
src/scn/add/scn_add_cam.c                       src/tfm/tfm_init.c \
src/scn/add/scn_add_mat.c                       src/tfm/tfm_move.c \
src/scn/add/scn_add_obj.c                       src/txr/txr_init.c \
src/scn/add/scn_add_to_group_copy.c             src/vlk/vlk_init.c \
src/scn/add/scn_add_to_group_grp.c \
src/scn/add/scn_add_to_group.c \
src/cmd/add/cmd_add_cylinder.c \
src/cmd/add/cmd_add_cone.c \
src/cmd/set/cmd_set_cone.c \
