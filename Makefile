...
src/cmd/set/cmd_set_copy.c                      src/mat/mat_init.c                              src/srv/srv_deinit.c \
src/cmd/set/cmd_set_cylinder.c                  src/mtl/fio_png_write.c                         src/srv/srv_ext.c \
src/cmd/set/cmd_set_group.c                     src/mtl/txr_reading_tmp.c                       src/srv/srv_ext_data.c \
...
src/cmd/utils/cmd_read_material.c               src/scn/add/scn_add_to_group_grp.c \
src/cmd/utils/cmd_read_num.c                    src/scn/add/scn_add_to_group_obj.c \
=======
src/cam/cam_init.c                              src/cmd/utils/cmd_read_txr_png.c                src/scn/add/scn_add_to_group_grp.c \
src/cmd/add/cmd_add.c                           src/cmd/utils/cmd_read_vec.c                    src/scn/add/scn_add_to_group_obj.c \
src/cmd/add/cmd_add_camera.c                    src/cmd/utils/cmd_set_read_attributes.c         src/scn/add/scn_add_txr.c \
src/cmd/add/cmd_add_cone.c                      src/cmd/utils/cmd_set_read_part.c               src/scn/get/scn_get_mat_by_name.c \
src/cmd/add/cmd_add_copy.c                      src/cmd/vfx/cmd_vfx.c                           src/scn/get/scn_get_num_of.c \
src/cmd/add/cmd_add_cylinder.c                  src/cmd/vfx/cmd_vfx_sum.c                       src/scn/get/scn_get_obj_by_id.c \
src/cmd/add/cmd_add_group.c                     src/cmd/vfx/cmd_vfx_sum_dest.c                  src/scn/get/scn_get_obj_by_name.c \
src/cmd/add/cmd_add_light.c                     src/cmd/vfx/cmd_vfx_sum_read.c                  src/scn/get/scn_get_txr_by_name.c \
src/cmd/add/cmd_add_material.c                  src/err/msg_err.c                               src/scn/move/scn_move_obj.c \
src/cmd/add/cmd_add_plane.c                     src/err/msg_ok.c                                src/scn/print/scn_print.c \
src/cmd/add/cmd_add_sphere.c                    src/err/msg_warn.c                              src/scn/print/scn_print_grp.c \
src/cmd/add/cmd_add_txr.c                       src/err/rt_err.c                                src/scn/print/scn_print_mat.c \
src/cmd/add/cmd_add_txr_to_scn.c                src/err/rt_warn.c                               src/scn/print/scn_print_obj.c \
...
src/cmd/set/cmd_set.c                           src/grp/grp_init.c                              src/scn/scn_id.c \
src/cmd/set/cmd_set_camera.c                    src/grp/grp_remove_by_name.c                    src/scn/scn_init.c \
src/cmd/set/cmd_set_cone.c                      src/gui/gui_builder.c                           src/scn/utils/scn_del_copies_of.c \
src/cmd/set/cmd_set_copy.c                      src/gui/gui_gtk_tree_view.c                     src/scn/utils/scn_group_mem.c \
src/cmd/set/cmd_set_cylinder.c                  src/gui/gui_init.c                              src/scn/utils/scn_name.c \
src/cmd/set/cmd_set_group.c                     src/gui/gui_list_widgets.c                      src/srv/srv_deinit.c \
src/cmd/set/cmd_set_light.c                     src/gui/gui_singals.c                           src/srv/srv_ext.c \
src/cmd/set/cmd_set_material.c                  src/gui/gui_style.c                             src/srv/srv_ext_data.c \
src/cmd/set/cmd_set_obj_to_scn.c                src/lgt/lgt_init.c                              src/srv/srv_init.c \
src/cmd/set/cmd_set_object.c                    src/mat/mat_init.c                              src/srv/srv_loop.c \
src/cmd/set/cmd_set_plane.c                     src/obj/obj_container_init.c                    src/srv/srv_parse.c \
src/cmd/set/cmd_set_prepare_obj.c               src/obj/obj_copy_init.c                         src/srv/srv_utils.c \
src/cmd/set/cmd_set_sphere.c                    src/obj/obj_init.c                              src/tfm/tfm_apply.c \
src/cmd/set/cmd_set_txr.c                       src/rt.c                                        src/tfm/tfm_init.c \
src/cmd/utils/cmd_read.c                        src/scn/add/scn_add_cam.c                       src/tfm/tfm_move.c \
src/cmd/utils/cmd_read_light.c                  src/scn/add/scn_add_ligth.c                     src/txr/txr_init.c \
...
src/cmd/utils/cmd_read_png_buf.c                src/scn/add/scn_add_to_group.c                  src/vlk/vlk_init.c \
src/cmd/utils/cmd_read_txr.c                    src/scn/add/scn_add_to_group_copy.c \
