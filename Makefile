...
src/cmd/cmd_render.h    src/gui/gui_types.h     src/scn/scn.h           src/txr/txr.h \
src/cmd/cmd_set.h       src/lgt/lgt.h           src/scn/scn_add.h       src/txr/txr_types.h \
src/cmd/cmd_types.h     src/lgt/lgt_types.h     src/scn/scn_id.h        src/vlk/vlk.h \
src/err/err.h           src/mat/mat.h           src/scn/scn_types.h \
...
SRC_SHARED	:= \
src/cam/cam_init.c                              src/cmd/utils/cmd_read_material.c               src/scn/add/scn_add_to_group_grp.c \
src/cmd/add/cmd_add.c                           src/cmd/utils/cmd_read_num.c                    src/scn/add/scn_add_to_group_obj.c \
src/cmd/add/cmd_add_camera.c                    src/cmd/utils/cmd_read_png_buf.c                src/scn/add/scn_add_txr.c \
src/cmd/add/cmd_add_cone.c                      src/cmd/utils/cmd_read_txr.c                    src/scn/get/scn_get_mat_by_name.c \
src/cmd/add/cmd_add_copy.c                      src/cmd/utils/cmd_read_txr_png.c                src/scn/get/scn_get_obj_by_id.c \
src/cmd/add/cmd_add_cylinder.c                  src/cmd/utils/cmd_set_read_attributes.c         src/scn/get/scn_get_obj_by_name.c \
src/cmd/add/cmd_add_group.c                     src/cmd/utils/cmd_set_read_part.c               src/scn/get/scn_get_obj_num.c \
src/cmd/add/cmd_add_light.c                     src/err/msg_err.c                               src/scn/get/scn_get_txr_by_name.c \
src/cmd/add/cmd_add_material.c                  src/err/msg_ok.c                                src/scn/move/scn_move_obj.c \
src/cmd/add/cmd_add_plane.c                     src/err/msg_warn.c                              src/scn/print/scn_print.c \
src/cmd/add/cmd_add_sphere.c                    src/err/rt_err.c                                src/scn/print/scn_print_grp.c \
src/cmd/add/cmd_add_txr.c                       src/err/rt_warn.c                               src/scn/print/scn_print_mat.c \
src/cmd/add/cmd_add_txr_to_scn.c                src/fio/fio_png_write.c                         src/scn/print/scn_print_obj.c \
src/cmd/cmd_error.c                             src/gpu/gpu_buffer_load.c                       src/scn/print/scn_print_txr.c \
src/cmd/cmd_parce_command.c                     src/gpu/gpu_buffer_materials.c                  src/scn/remove/scn_remove_by_name_cam.c \
src/cmd/cmd_parse.c                             src/gpu/gpu_buffer_objects.c                    src/scn/remove/scn_remove_by_name_copy.c \
src/cmd/ls/cmd_ls.c                             src/gpu/gpu_init.c                              src/scn/remove/scn_remove_by_name_grp.c \
src/cmd/render/cmd_on_render.c                  src/gpu/gpu_kernel_run.c                        src/scn/remove/scn_remove_by_name_lgt.c \
src/cmd/render/cmd_render.c                     src/gpu/gpu_render.c                            src/scn/remove/scn_remove_by_name_mat.c \
src/cmd/render/cmd_render_read.c                src/grp/grp_init.c                              src/scn/remove/scn_remove_by_name_obj.c \
src/cmd/rm/cmd_rm.c                             src/grp/grp_remove_by_name.c                    src/scn/remove/scn_remove_by_name_txr.c \
src/cmd/rm/cmd_rm_by_name.c                     src/gui/gui_builder.c                           src/scn/scn_id.c \
src/cmd/rm/cmd_rm_material.c                    src/gui/gui_gtk_tree_view.c                     src/scn/scn_init.c \
src/cmd/set/cmd_set.c                           src/gui/gui_init.c                              src/scn/utils/scn_del_copies_of.c \
src/cmd/set/cmd_set_camera.c                    src/gui/gui_list_widgets.c                      src/scn/utils/scn_group_mem.c \
src/cmd/set/cmd_set_cone.c                      src/gui/gui_singals.c                           src/scn/utils/scn_name.c \
src/cmd/set/cmd_set_copy.c                      src/gui/gui_style.c                             src/srv/srv_deinit.c \
src/cmd/set/cmd_set_cylinder.c                  src/lgt/lgt_init.c                              src/srv/srv_ext.c \
src/cmd/set/cmd_set_group.c                     src/mat/mat_init.c                              src/srv/srv_ext_data.c \
