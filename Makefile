...
SRC_SHARED	:= \
src/cam/cam_init.c                              src/cmd/utils/cmd_read_txr.c                    src/scn/add/scn_add_to_group_grp.c \
src/cmd/add/cmd_add.c                           src/cmd/utils/cmd_read_txr_png.c                src/scn/add/scn_add_to_group_obj.c \
...
src/cmd/add/cmd_add_copy.c                      src/cmd/vfx/cmd_vfx.c                           src/scn/get/scn_get_obj_by_id.c \
src/cmd/add/cmd_add_cylinder.c                  src/cmd/vfx/cmd_vfx_sum.c                       src/scn/get/scn_get_obj_by_name.c \
src/cmd/add/cmd_add_group.c                     src/cmd/vfx/cmd_vfx_sum_dest.c                  src/scn/get/scn_get_obj_num.c \
...
src/cmd/cmd_parce_command.c                     src/gpu/gpu_buffer_load.c                       src/scn/remove/scn_remove_by_name_cam.c \
src/cmd/cmd_parse.c                             src/gpu/gpu_buffer_materials.c                  src/scn/remove/scn_remove_by_name_copy.c \
src/cmd/ls/cmd_ls.c                             src/gpu/gpu_buffer_objects.c                    src/scn/remove/scn_remove_by_name_grp.c \
src/cmd/render/cmd_render.c                     src/gpu/gpu_init.c                              src/scn/remove/scn_remove_by_name_lgt.c \
src/cmd/rm/cmd_rm.c                             src/gpu/gpu_kernel_run.c                        src/scn/remove/scn_remove_by_name_mat.c \
src/cmd/rm/cmd_rm_by_name.c                     src/gpu/gpu_render.c                            src/scn/remove/scn_remove_by_name_obj.c \
src/cmd/rm/cmd_rm_material.c                    src/grp/grp_init.c                              src/scn/remove/scn_remove_by_name_txr.c \
src/cmd/set/cmd_set.c                           src/grp/grp_remove_by_name.c                    src/scn/scn_id.c \
src/cmd/set/cmd_set_camera.c                    src/gui/gui_builder.c                           src/scn/scn_init.c \
src/cmd/set/cmd_set_cone.c                      src/gui/gui_gtk_tree_view.c                     src/scn/utils/scn_del_copies_of.c \
src/cmd/set/cmd_set_copy.c                      src/gui/gui_init.c                              src/scn/utils/scn_group_mem.c \
src/cmd/set/cmd_set_cylinder.c                  src/gui/gui_list_widgets.c                      src/scn/utils/scn_name.c \
src/cmd/set/cmd_set_group.c                     src/gui/gui_singals.c                           src/srv/srv_deinit.c \
src/cmd/set/cmd_set_light.c                     src/gui/gui_style.c                             src/srv/srv_ext.c \
src/cmd/set/cmd_set_material.c                  src/lgt/lgt_init.c                              src/srv/srv_ext_data.c \
src/cmd/set/cmd_set_obj_to_scn.c                src/mat/mat_init.c                              src/srv/srv_init.c \
src/cmd/set/cmd_set_object.c                    src/obj/obj_container_init.c                    src/srv/srv_loop.c \
src/cmd/set/cmd_set_plane.c                     src/obj/obj_copy_init.c                         src/srv/srv_parse.c \
src/cmd/set/cmd_set_prepare_obj.c               src/obj/obj_init.c                              src/srv/srv_utils.c \
src/cmd/set/cmd_set_sphere.c                    src/rt.c                                        src/tfm/tfm_apply.c \
src/cmd/set/cmd_set_txr.c                       src/scn/add/scn_add_cam.c                       src/tfm/tfm_init.c \
src/cmd/utils/cmd_read.c                        src/scn/add/scn_add_ligth.c                     src/tfm/tfm_move.c \
src/cmd/utils/cmd_read_light.c                  src/scn/add/scn_add_mat.c                       src/txr/txr_init.c \
src/cmd/utils/cmd_read_material.c               src/scn/add/scn_add_obj.c                       src/txr/txr_rgba_to_rgb.c \
src/cmd/utils/cmd_read_num.c                    src/scn/add/scn_add_to_group.c                  src/txr/txr_sum.c \
src/cmd/utils/cmd_read_png_buf.c                src/scn/add/scn_add_to_group_copy.c             src/vlk/vlk_init.c \
